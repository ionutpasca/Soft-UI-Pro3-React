...
const Profile = (props) => {
  return (
    <div className="profile-container">
      <Helmet>
        <title>Profile - Soft UI Pro3</title>
        <meta property="og:title" content="Profile - Soft UI Pro3" />
      </Helmet>
          ...
          <div className="profile-form">
            ...
            <form className="profile-form1">
              ...
              <input
                ...
                className="profile-textinput input small"
              />
              ...
              <input
                ...
                className="profile-textinput1 input small"
              />
